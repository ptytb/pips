...
class BKTree {
    ...
    [void] SaveArrays() {
        ...
        $fs = New-Object System.IO.FileStream "$PSScriptRoot\known-packages-bktree.bin", ([System.IO.FileMode]::Create)
    ...
    [void] LoadArrays() {
        $fs = New-Object System.IO.FileStream "$PSScriptRoot\known-packages-bktree.bin", ([System.IO.FileMode]::Open)
        $bf = New-Object System.Runtime.Serialization.Formatters.Binary.BinaryFormatter
